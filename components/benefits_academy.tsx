...
export default function BenefitsComparisonSection() {
  return (
    <section className="relative bg-gradient-to-b from-purple-50 to-pink-50 py-32 overflow-hidden">
      {/* Abstract watercolor blobs */}
      <div className="absolute -top-40 -left-40 w-80 h-80 bg-purple-200 rounded-full mix-blend-multiply filter blur-2xl opacity-30" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-pink-200 rounded-full mix-blend-multiply filter blur-2xl opacity-30" />
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="mt-4 text-xl text-gray-700 max-w-3xl mx-auto">
            Break free from one-size-fits-all training and embrace a smarter, scalable solution.
          </p>
        </motion.div>
          ...
          {comparisons.map(({ label, arised, traditional }, idx) => (
            ...
            >
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="flex flex-col items-center">
                  <div className={`p-3 rounded-full ${arised ? 'bg-gradient-to-br from-purple-500 to-pink-500' : 'bg-gray-100'} mb-2 flex items-center justify-center`}>
                    {arised ? (
              ...
              {/* Accent Bar */}
              <motion.div
                className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-16 h-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full"
                initial={{ scaleX: 0 }}
                whileHover={{ scaleX: 1 }}
