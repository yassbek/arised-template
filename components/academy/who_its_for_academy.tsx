...
export default function WhoItsForSection() {
  return (
    <section className="relative bg-gradient-to-b from-white to-gray-50 py-24">
      {/* shapes are behind this section’s content but will overflow up into the previous section */}
      <motion.div
        className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/3 w-[600px] h-[600px] bg-indigo-100 rounded-full opacity-10 z-0"
      ...
      />
      <motion.div
        className="absolute bottom-0 right-1/3 w-[500px] h-[500px] bg-pink-100 rounded-full opacity-10 z-0"
        initial={{ scale: 0.8, opacity: 0 }}
        whileInView={{ scale: 1, opacity: 1 }}
        viewport={{ once: true }}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6">
        ...
        >
          <h2 className="text-4xl font-extrabold text-gray-900">Who We’re For</h2>
